      ...
      <div class="card-body pb-0">
       <h5 class="card-title">All Our  <span> Patience</span></h5>
            ...
            <th scope="row"><?php echo $row['id'];?></th>
              ...
              <td><a href="show_record.php?record=<?php echo $row['id'];?>" class="text-primary fw-bold"><?php echo $row['fullname'];?> </a></td>
              <td><?php echo $row['sickness'];?></td>
              <td><?php echo $row['dates'];?></td>
             
              <td><a href="add_record.php?edit=<?php echo $row['id'];?>"> <i class="bi bi-pencil-square"></i>   </a></td>
...
<div class="modal fade" id="errorModal" tabindex="-1" style="display: none;" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       Unable to delete the record</br>
