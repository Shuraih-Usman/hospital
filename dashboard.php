        ...
        <div class="col-12">
          <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
              ...
              <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns"><div class="dataTable-top"><div class="dataTable-dropdown"></div></div><div class="dataTable-container"><table class="table table-borderless datatable dataTable-table">
                <thead>
              ...
              </table></div><div class="dataTable-bottom"><nav class="dataTable-pagination"><ul class="dataTable-pagination-list"></ul></nav></div></div>
        ...
        <div class="col-12">
          <div class="card top-selling overflow-auto">
            ...
            <div class="card-body pb-0">
              <h5 class="card-title">Record <span>| Recent added</span></h5>
              ...
              foreach ($resrec as $row) {
                echo '<tr>
                <th scope="row"><a href="show_record.php?record='.$row['id'].'"><img src="admin/uploads/'.$row['images'].'" alt=""></a></th>
